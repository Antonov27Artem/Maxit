...
def main():
    ...
    CurrentPlayer = 1  # Начинает первый игрок (по правилам игры)
    ...
    while True:
        ...
        while correct != 1:
            ...
            if str(choice).isdigit():  # Проверка, является ли введённое значение числом
                correct = 1
                choice = int(choice)
            else:
                print("Ошибка. Пожалуйста, попробуйте ещё раз.")
